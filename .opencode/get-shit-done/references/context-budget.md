...
The keys live in `.claude/settings.json` (project) or `/Users/danhtran/myData/src_learn/pill-counter/.opencode/settings.json` (global) — **not** in `.planning/config.json`:

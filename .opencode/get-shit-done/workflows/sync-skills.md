...
INSTALL_JS_GLOBAL="/Users/danhtran/myData/src_learn/pill-counter/.opencode/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/danhtran/myData/src_learn/pill-counter/.opencode/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.

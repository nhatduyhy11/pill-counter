...
```
Agent(
  prompt="Read /Users/danhtran/myData/src_learn/pill-counter/.opencode/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/danhtran/myData/src_learn/pill-counter/.opencode/get-shit-done/templates/VALIDATION.md`

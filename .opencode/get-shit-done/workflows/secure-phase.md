...
```
Agent(
  prompt="Read /Users/danhtran/myData/src_learn/pill-counter/.opencode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/danhtran/myData/src_learn/pill-counter/.opencode/get-shit-done/templates/SECURITY.md`

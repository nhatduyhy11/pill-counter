...
<reference>
@/Users/danhtran/myData/src_learn/pill-counter/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/danhtran/myData/src_learn/pill-counter/.claude/get-shit-done/references/user-profiling.md` to load:

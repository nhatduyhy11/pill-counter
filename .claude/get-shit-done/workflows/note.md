...
- **Global scope**: `/Users/danhtran/myData/src_learn/pill-counter/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/danhtran/myData/src_learn/pill-counter/.claude/notes/`)
...
2. Glob `/Users/danhtran/myData/src_learn/pill-counter/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/danhtran/myData/src_learn/pill-counter/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/danhtran/myData/src_learn/pill-counter/.claude/notes/` — works in any directory

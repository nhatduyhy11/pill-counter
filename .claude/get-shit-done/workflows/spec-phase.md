...
```bash
INIT=$(node "/Users/danhtran/myData/src_learn/pill-counter/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/danhtran/myData/src_learn/pill-counter/.claude/get-shit-done/templates/spec.md.

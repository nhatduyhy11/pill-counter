...
```
Agent(
  prompt="Read /Users/danhtran/myData/src_learn/pill-counter/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/danhtran/myData/src_learn/pill-counter/.claude/get-shit-done/templates/SECURITY.md`

...
- Usage: Reference from command with `@/Users/danhtran/myData/src_learn/pill-counter/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/danhtran/myData/src_learn/pill-counter/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/danhtran/myData/src_learn/pill-counter/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
